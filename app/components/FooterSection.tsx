            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10">
                ...
                <div className="grid lg:grid-cols-3 gap-6 mb-16">
                    ...
                    <div className="lg:col-span-2 rounded-2xl overflow-hidden relative group"
                        ...
                        {/* Address overlay */}
                        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-[#1a1008] via-[#1a1008]/80 to-transparent pointer-events-none transition-opacity duration-300">
                    ...
                    <div className="rounded-2xl p-7 space-y-6"
                        ...
                        {/* Социальные сети с кастомными SVG */}
                                    ...
                                    },
                                    {
                                        ...
                                        icon: (
                                            <svg viewBox="0 0 1000 1000" className="w-full h-full">
                                                <defs>
                                                    <linearGradient id="max-bg1" x1="117.847" x2="1000" y1="760.536" y2="500" gradientUnits="userSpaceOnUse">
                                                        <stop offset="0" stopColor="#4cf" />
                                                        <stop offset=".662" stopColor="#53e" />
                                                        <stop offset="1" stopColor="#93d" />
                                                    </linearGradient>
                                                    <radialGradient id="max-bg2" cx="-87.392" cy="1166.116" r="500" fx="-87.392" fy="1166.116" gradientTransform="rotate(51.356 1551.478 559.3) scale(2.42703433 1)" gradientUnits="userSpaceOnUse">
                                                        <stop offset="0" stopColor="#00f" />
                                                        <stop offset="1" stopOpacity="0" />
                                                        <stop offset="1" stopOpacity="0" />
                                                    </radialGradient>
                                                </defs>
                                                <rect width="1000" height="1000" fill="url(#max-bg1)" ry="249.681" />
                                                <rect width="1000" height="1000" fill="url(#max-bg2)" ry="249.681" />
